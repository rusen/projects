...
public class PeopleMenu extends Activity{
	...
	private String firstName,secondName,thirdName,fourthName, firstJob,secondJob,thirdJob,fourthJob,projectName;
	...
	TextView personJob1,personJob2,personJob3,personJob4,proname;
...
public void onCreate(Bundle savedInstanceState) {
 	    ...
 	    // 	    DBAdapter.addUsers();
	    	...
	    	people = DBAdapter.getProject(projectID);
	    	
	    	projectName = people.getString(1);
	    	
	    	proname = (TextView) findViewById(R.id.eventname); //R.id.eventname is used as project name here
	    	proname.setVisibility(0);
	   		
	    	proname.setText(projectName);
	    	
	    	
	    	people = DBAdapter.getProjectPeople(projectID);
...
//		  	personButton4 = (Button)findViewById(R.id.fourth);
		...
		addUserButton.setOnClickListener(new View.OnClickListener(){ 
		  ...
		  //  	preview[2] = new String();
				...
				DBAdapter.addUserToProject(user.getLong(0),projectID);
				DBAdapter.close();
				openPeople();
			}
			});
