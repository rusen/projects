...
class Vector3
{
	...
	float indexOfMinComponent() const;
	float indexOfMinAbsComponent() const;
	float indexOfMaxComponent() const;
	float indexOfMaxAbsComponent() const;
	...
	friend Vector3 multip(const Vector3& v1, const Vector3& v2);
...
inline float Vector3::squaredLenght() const
...
inline float Vector3::indexOfMinComponent() const {
	int index = 0;
	float temp = e[0];
...
inline float Vector3::indexOfMinAbsComponent() const {
	int index = 0;
	float temp = fabs(e[0]);
...
inline float Vector3::indexOfMaxComponent() const {
	int index = 0;
	float temp = e[0];
...
inline float Vector3::indexOfMaxAbsComponent() const {
	int index = 0;
	float temp = fabs(e[0]);
...
inline Vector3 multip(const Vector3 &v1, const Vector3 &v2)
{ 
	Vector3 temp;
